...
const LOG_SPARQL_QUERIES = process.env.LOG_SPARQL_QUERIES != undefined
    ? env.get("LOG_SPARQL_QUERIES").asBool()
    : env.get("LOG_SPARQL_ALL").asBool();
const LOG_SPARQL_UPDATES = process.env.LOG_SPARQL_UPDATES != undefined
...
export { newSparqlClient, SPARQL as SPARQL, SPARQL as sparql, query, update, sparqlEscape, sparqlEscapeString, sparqlEscapeUri, sparqlEscapeDecimal, sparqlEscapeInt, sparqlEscapeFloat, sparqlEscapeDate, sparqlEscapeDateTime, sparqlEscapeBool, };
